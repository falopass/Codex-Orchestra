...
- Worktree execution and merge preview for write-heavy parallel tasks.
- Browser/desktop QA matrix with automated screenshots on Windows.
- Provider-specific pricing import with effective dates and source validation.
